<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Voz.aspx.vb" Inherits="Voz" %>
  ...
  <body>
	...
	<!-- contenido gral -->	
      ...
      <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <form id="frmBuscar" class="form-signin" runat="server">

                <table class="table table-condensed"">
                    <tr>
                        <td><label for="txtNombre">Nombre</label></td>
                        <td><asp:TextBox ID="txtNombre" runat="server" class="form-control"  x-webkit-speech></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="2">
            ...
            <div class="col-md-4">
                <asp:Label ID="lblDatos" runat="server" Text=""></asp:Label></div>
            </div>
