<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BajaCaballo.aspx.vb" Inherits="Admin_Baja" %>
...
<br />	  
     ...
     <table class="table table-condensed">
                    <tr>
                        ...
                        <td><label for="ddNombre">Nombre</label></td>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td><asp:TextBox ID="txtrp" runat="server" class="form-control"></asp:TextBox></td>
                         <td><label for="txtProvisorio">Provisorio</label></td>
                        <td><asp:TextBox ID="txtProvisorio" runat="server" class="form-control"></asp:TextBox></td>
                    </tr>
                     <tr>
                        <td><asp:Button ID="btnGuardar" runat="server" Text="Borrar" class="btn btn-primary" /></td>
						<td colspan="3">
