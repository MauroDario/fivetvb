<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ModificacionCaballo.aspx.vb" Inherits="Admin_Baja" %>
...
<br />	  
      ...
      <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h2>Modificacion de Caballos</h2>
                <form id="frmBaja" class="form-horizontal" role="form" runat="server">
     <table class="table table-condensed">
      <tr>
                        <td><label for="txtPrefijo">Busqueda por Nombre</label></td>
                        <td><asp:DropDownList ID="ddNombre" runat="server" class="form-control" AutoPostBack ="true"></asp:DropDownList></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><label for="txtacronimo">Ubicacion</label></td>
                        <td><asp:DropDownList ID="ddUbicacion" runat="server" class="form-control"></asp:DropDownList></td>
                    </tr>
                     <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td><asp:Button ID="btnGuardar" runat="server" Text="Modificar" 
