<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Alta.aspx.vb" Inherits="Admin_Alta" %>
            ...
            <div class="col-md-6">
                ...
                <table class="table table-condensed">
                    <tr>
                        ...
                        <td><asp:TextBox ID="txtApellido" runat="server" class="form-control"></asp:TextBox></td>
                    </tr>
                    <tr>
